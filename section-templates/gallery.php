<?php 
global $section_id;
$meal_section_meta = get_post_meta($section_id, 'section_gallery_meta_box', true);

$meal_section = get_post($section_id);
$meal_section_title = $meal_section->post_title;
$meal_section_desc = $meal_section->post_content;
?>
<div class="section pb-3 bg-white" data-aos="fade-up" id="<?php echo esc_attr($meal_section->post_name); ?>">
    <div class="container">
...
<?php 
$meal_gallery_items = $meal_section_meta['gallery'];
            ...
            <div class="col-md-12">
                <div class="text-center">
                    <ul class="portfolio-filter text-center">
                        ...
                        <li>
                            <a href="#"
                                data-filter=".<?php echo esc_attr($meal_item_category); ?>"><?php echo esc_html($meal_item_category); ?>
                            </a>
                        </li>
                        <?php endforeach; ?>
                    </ul>
                ...
                <div class="portfolio-grid portfolio-gallery grid-4 gutter">
                    ...
                    foreach($meal_gallery_items as $meal_gallery_item):
                        ...
                        $meal_item_thumbnail = wp_get_attachment_image_src( $meal_item_image_id, "large" );
                    ...
                    <div class="portfolio-item <?php echo esc_attr($meal_item_class); ?>">
                        <a class="portfolio-image popup-gallery" href="<?php echo esc_url($meal_item_large[0]); ?>">
