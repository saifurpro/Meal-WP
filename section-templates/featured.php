<?php 
global $section_id;
$meal_section_meta = get_post_meta($section_id, 'section_featured_meta_box', true);
    ...
    <div class="container">
        <div class="row section-heading justify-content-center mb-5">
            <div class="col-md-8 text-center">
                ...
                <p class="sub-heading mb-5"><?php echo esc_html($meal_section_desc); ?>
                </p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="ftco-46">
                <div class="ftco-46-row d-flex flex-column flex-lg-row">
                    ...
                    <div class="ftco-46-text ftco-46-arrow-left">
                        <h4 class="ftco-46-subheading">
                            <?php echo esc_html(get_recipe_category($meal_recipe_one->ID)); ?></h4>
                        ...
                        <p><a href="<?php echo get_the_permalink($meal_recipe_one); ?>"
                                class="btn-link"><?php _e('Learn More', 'meal'); ?> <span
                ...
                <div class="ftco-46-row d-flex flex-column flex-lg-row">
                    <div class="ftco-46-text ftco-46-arrow-right">
                        <h4 class="ftco-46-subheading">
                            <?php echo esc_html(get_recipe_category($meal_recipe_three->ID)); ?></h4>
                    ...
                    <div class="ftco-46-text ftco-46-arrow-up">
                        <h4 class="ftco-46-subheading">
                            <?php echo esc_html(get_recipe_category($meal_recipe_two->ID)); ?></h4>
                        ...
                        <p><a href="<?php echo get_the_permalink($meal_recipe_two); ?>"
                                class="btn-link"><?php _e('Learn More', 'meal'); ?> <span
                                    class="ion-android-arrow-forward"></span></a></p>
                    </div>
                </div>
